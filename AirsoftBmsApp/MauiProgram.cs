    ...
    public static class MauiProgram
    {
        public static MauiApp CreateMauiApp()
        {
            ...
            else
            {
                ...
                builder.Services.AddHttpClient<IBattleRestService, BattleRestService>(client =>
                {
                ...
                builder.Services.AddHttpClient<ILocationRestService, LocationRestService>(client =>
                {
                    client.BaseAddress = new Uri($"{baseAddress}/Location/");
                });

                builder.Services.AddHttpClient<IOrderRestService, OrderRestService>(client =>
                {
