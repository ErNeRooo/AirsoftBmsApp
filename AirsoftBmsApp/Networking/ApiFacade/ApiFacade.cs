...
namespace AirsoftBmsApp.Networking.ApiFacade
{
        ...
        ) : IApiFacade
    {
        ...
        public IOrderHandler Order { get; } = orderHandler;
        public IMapPingHandler MapPing { get; } = mapPingHandler;
        public IZoneHandler Zone { get; } = zoneHandler;
    }
}
